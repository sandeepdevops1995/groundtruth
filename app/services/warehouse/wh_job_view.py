...
class WarehouseJobView(object):
    def get_job_details(self,job_order,job_type,container_flag):
        ...
        if job_type == JobOrderType.CARTING_FCL.value:
            result = WarehouseCarting().get_carting_details(job_order,job_type,constants.KEY_CARTING_FCL_SERVICE_TYPE,constants.KEY_CARTING_FCL_SERVICE_NAME,constants.KEY_CARTING_FCL_PORT_NAME,{constants.CCLS_CRN_NUMBER:job_order})
        elif job_type == JobOrderType.CARTING_LCL.value:
            result = WarehouseCarting().get_carting_details(job_order,job_type,constants.KEY_CARTING_LCL_SERVICE_TYPE,constants.KEY_CARTING_LCL_SERVICE_NAME,constants.KEY_CARTING_LCL_PORT_NAME,{constants.CCLS_ORDER_NO:job_order})
        elif job_type == JobOrderType.STUFFING_FCL.value:
            result = WarehouseStuffing().get_stuffing_details(job_order,job_type,constants.KEY_STUFFING_FCL_SERVICE_TYPE,constants.KEY_STUFFING_FCL_SERVICE_NAME,constants.KEY_STUFFING_FCL_PORT_NAME,{constants.CCLS_CONTAINER_NUMBER:job_order})
        elif job_type == JobOrderType.STUFFING_LCL.value:
            result = WarehouseStuffing().get_stuffing_details(job_order,job_type,constants.KEY_STUFFING_LCL_SERVICE_TYPE,constants.KEY_STUFFING_LCL_SERVICE_NAME,constants.KEY_STUFFING_LCL_PORT_NAME,{constants.CCLS_CONTAINER_NUMBER:job_order})
            ...
            result = WarehouseDelivery().get_delivery_details(job_order,job_type,constants.KEY_DELIVERY_LCL_SERVICE_TYPE,constants.KEY_DELIVERY_LCL_SERVICE_NAME,constants.KEY_DELIVERY_LCL_PORT_NAME,{constants.CCLS_GPM_NUMBER:job_order})
