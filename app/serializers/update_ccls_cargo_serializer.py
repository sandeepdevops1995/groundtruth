...
class CCLSBillDetailsUpdateSchema(ma.SQLAlchemyAutoSchema):
    ...
    class Meta:
        ...
        fields = ("id","shipping_bill_number", "boe_number","bol_number","bill_date","importer_code","importer_name","package_code","no_of_packages_declared","package_weight","cha_code","cargo_type","commodity_id","job_order_id")
        # include_relationships = True
        load_instance = True
        unknown = EXCLUDE
...
class CCLSCargoUpdateSchema(ma.SQLAlchemyAutoSchema):
    ...
    class Meta:
        ...
        fields = ("id","gross_weight", "private_or_concor_labour_flag", "shipping_liner_code","cncl_flag","icd_location_code","container_info","carting_details","job_type","fcl_or_lcl","stuffing_details","destuffing_details","delivery_details")
        include_relationships = True
        load_instance = True
        unknown = EXCLUDE
