...
class CCLSRake(db.Model):
    ...
    wagon_ldd_mt = db.Column(db.String(1))
    wagon_owner = db.Column(db.String(25))
    container_number = db.Column(db.String(11))
    container_life_number = db.Column(db.String(11))
    ...
    container_stg_flag = db.Column(db.String(1))
    container_iwb_flag = db.Column(db.String(1))
    cargo_type = db.Column(db.String(25))
    fcl_lcl_flg = db.Column(db.String(1))
    station_cd = db.Column(db.String(25))
    gw_port_cd = db.Column(db.String(25))
    error_flg = db.Column(db.String(1))
    ...
    adv_boe_flg = db.Column(db.String(2))
    error_msg = db.Column(db.String(100))
    status_flg = db.Column(db.String(1))
