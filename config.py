...
IS_REQUIRED_TO_SEND_DATA_TO_CCLS=env.bool('IS_REQUIRED_TO_SEND_DATA_TO_CCLS')
ENABLE_TEST_DB_READ = env.bool('ENABLE_TEST_DB_READ',False)
#logstash config
...
REDIS_TASK_SLEEP_TIME = 5 #in seconds