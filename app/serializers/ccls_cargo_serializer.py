...
class CartingJobInsertSchema(ma.SQLAlchemyAutoSchema):
    ...
    class Meta:
        ...
        fields = ("crn_number", "crn_date", "carting_order_number","con_date","is_cargo_card_generated","cha_code","gw_port_code","party_code","reserve_flag","max_date_unloading","contractor_job_order_no","contractor_job_order_date","exporter_name","container_details")
...
class StuffingJobInsertSchema(ma.SQLAlchemyAutoSchema):
    ...
    class Meta:
        ...
        fields = ("container_number", "stuffing_job_order", "crn_number", "cargo_weight_in_crn","gw_port_code","crn_date")
        include_relationships = True
        load_instance = True
...
class CCLSCargoInsertSchema(ma.SQLAlchemyAutoSchema):
    ...
    class Meta:
        ...
        fields = ("gross_weight", "private_or_concor_labour_flag", "shipping_liner_code","cncl_flag","icd_location_code","truck_details","container_info","bill_details","carting_details","job_type","fcl_or_lcl","stuffing_details","destuffing_details","delivery_details","cha_name","seal_number")
        include_relationships = True
        load_instance = True
        unknown = EXCLUDE
