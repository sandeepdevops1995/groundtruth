...
#revenue
#expot
KEY_IMPORT_REVENUE_SERVICE_TYPE='ImportBillDetails'
KEY_IMPORT_REVENUE_SERVICE_NAME='importbill_details'
KEY_IMPORT_REVENUE_PORT_NAME='CWHImportReadBPL'

#import
KEY_EXPORT_REVENUE_SERVICE_TYPE='ExportBillDetails'
KEY_EXPORT_REVENUE_SERVICE_NAME='exportbill_details'
KEY_EXPORT_REVENUE_PORT_NAME='CWHExportReadBPL'

#revenue amount info
KEY_EXPORT_FCL_ESTIMATED_REVENUE_SERVICE_TYPE='CWHRevenueRead'
KEY_EXPORT_FCL_ESTIMATED_REVENUE_SERVICE_NAME='cwhrevenuereadbpel_client_ep'
KEY_EXPORT_FCL_ESTIMATED_REVENUE_PORT_NAME='CWHRevenueReadBPEL_pt'

KEY_EXPORT_LCL_ESTIMATED_REVENUE_SERVICE_TYPE='CWHRevenueRead'
KEY_EXPORT_LCL_ESTIMATED_REVENUE_SERVICE_NAME='cwhrevenuereadbpel_client_ep'
KEY_EXPORT_LCL_ESTIMATED_REVENUE_PORT_NAME='CWHRevenueReadBPEL_pt'

KEY_IMPORT_FCL_ESTIMATED_REVENUE_SERVICE_TYPE='CWHRevenueRead'
KEY_IMPORT_FCL_ESTIMATED_REVENUE_SERVICE_NAME='cwhrevenuereadbpel_client_ep'
KEY_IMPORT_FCL_ESTIMATED_REVENUE_PORT_NAME='CWHRevenueReadBPEL_pt'

KEY_IMPORT_LCL_ESTIMATED_REVENUE_SERVICE_TYPE='CWHRevenueRead'
KEY_IMPORT_LCL_ESTIMATED_REVENUE_SERVICE_NAME='cwhrevenuereadbpel_client_ep'
KEY_IMPORT_LCL_ESTIMATED_REVENUE_PORT_NAME='CWHRevenueReadBPEL_pt'